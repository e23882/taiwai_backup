...
<body style="background-color:#b1b2b4;">
	...
	<div id="middle" style="width:80%; background-color:white; padding-bottom:200px; ">
		...
		<div id="main" style=" padding:30; text-align:left; letter-spacing:3px; height:310px; ">
	
		<table>
				<tr>
					<td colspan="2" style=" font-size:30px; font-family:impact; padding-bottom:30px;">Latest News</td>
				</tr>
				<!--公司簡介段落一-->
				<?php
				...
				try 
				{
					...
					{
						echo "<tr><td style='vertical-align:top; padding-bottom:20px;'>						
						<a href='".$value->link."' style='color:#000088;padding-left:0;'>".$value->title."</a>
					</td>
					<td style='width:150px; padding-left:10px; color:#0044BB; '>".$value->date."</td></tr>";
					}
